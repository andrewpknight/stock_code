...
summary.lm.clustered <- function (object, correlation = FALSE, 
                        symbolic.cor = FALSE, robust=FALSE,
                        cluster=c(NULL,NULL),...) {
  
  # Make sure the call is a formula
  object$call$formula = as.formula(object$call$formula)
